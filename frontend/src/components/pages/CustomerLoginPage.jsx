    ...
    <div className={`${styles.page} content-wrapper`}>
      <div className={styles.container}>
        ...
        <footer className={styles.footer}>
          ...
          <p>Don’t have an account? <Link to="/signup/customer" className={styles.footerLink}>Sign Up Now</Link></p>
          <p>Are you a partner? <Link to="/login/tailor" className={styles.footerLink}>Login as Partner</Link></p>
        </footer>
      </div>
    </div>
  );
